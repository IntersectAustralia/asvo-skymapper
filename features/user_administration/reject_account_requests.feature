Feature: Reject access requests
  ...
  Scenario: Reject an access request from the list page
    ...
    And "diego@intersect.org.au" should receive an email with subject "SkyMapper - Your access request has been rejected"
    When I open the email
    Then I should see "You made a request for access to the SkyMapper System. Your request has been rejected. Please contact the SkyMapper team for further information." in the email body
  ...
  Scenario: Reject an access request as spam from the list page
    ...
    Then they should see "You made a request for access to the SkyMapper System. Your request has been rejected. Please contact the SkyMapper team for further information." in the email body
  ...
  Scenario: Rejected user should be able to apply again
    ...
    And I fill in the following:
      | Email Address    | diego@intersect.org.au |
      | Password         | Pas$w0rd               |
