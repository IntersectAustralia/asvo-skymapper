...
describe Registry do
  ...
  it 'Registry includes fields for image catalogue in skymapper dataset' do
    ...
    fields.should == {
        ...
        object_id: { field: 'OBJECT_ID', name: 'Object id', group: 'group1' },
        title: { field: 'TITLE', name: 'Title', group: 'group1' },
        night_id: { field: 'NIGHT_ID', name: 'Night id', group: 'group1' },
        combined_id: { field: 'COMBINED_ID', name: 'Combined id', group: 'group1' },
        naxes: { field: 'NAXES', name: 'N axes', group: 'group1' },
        naxis: { field: 'NAXIS', name: 'N axis', group: 'group1' },
        scale: { field: 'SCALE', name: 'Scale', group: 'group1' },
        format: { field: 'FORMAT', name: 'Format', group: 'group2' },
